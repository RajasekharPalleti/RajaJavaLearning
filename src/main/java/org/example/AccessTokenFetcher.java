...
public class AccessTokenFetcher {
    ...
    private static final String CLIENT_ID = "resource_server"; // Replace with your actual client ID
    private static final String CLIENT_SECRET = "resource_server"; // Replace with your actual client secret

    public static void main(String[] args) {
        String token = getAccessToken("asp", "9649964096", "123456"); // Calling the method to print the recieved access token
        System.out.println(token);
    }

    public static String getAccessToken(String tenantCode, String username, String password) {
